...
public class GuiOptionsPageSway implements GameStartEntrypoint
{
	...
	public static final OptionsPage SwayOptionsPage = OptionsPages.register(new OptionsPage("swaymod.options.title")
	...
	{
		return new GuiOptions(parent, gameSettings, SwayOptionsPage);
	}
